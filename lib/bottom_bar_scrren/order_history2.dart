    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(children: [
          ...
          Container(height: 240,width: 360,color: Colors.white,
            child: Column(children: [
              Padding(
              ...
              RichText(
                  text: TextSpan(text: "", children: [
                    WidgetSpan(child: Padding(
                      ...
                      child: Text("Bill Amount ",style: TextStyle(fontWeight: FontWeight.w500),),
              ...
              RichText(
                  text: TextSpan(text: "", children: [
                    WidgetSpan(child: Padding(
                      ...
                      child: Text("Anvance  Deposit",style: TextStyle(fontWeight: FontWeight.w500),),
              ...
              RichText(
                  text: TextSpan(text: "", children: [
                    WidgetSpan(child: Padding(
                      padding: const EdgeInsets.only(right: 170),
                      child: Text("Advance Deposit by",style: TextStyle(fontWeight: FontWeight.w500),),
